...
/**
 * Factory for Persistent Format Annotation
 *
 * @author David
 */
public class PersistentAnnotationFormatterFactory implements AnnotationFormatterFactory<PersistentFormat>, InitializingBean {
    ...
    /**
     * Find all persistent class annotated with PersistentFormat.class
     *
     * @return set of class annotated with PersistentFormat.class
     */
