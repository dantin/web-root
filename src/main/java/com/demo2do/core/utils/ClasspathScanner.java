 ...
 * specific annotation. However, through the use of the {@link com.demo2do.core.utils.ClasspathScanner.Test} class it is
 ...
 * {@link #find(com.demo2do.core.utils.ClasspathScanner.Test, String...)} ()} method and supplying a
...
public class ClasspathScanner<T> {
     ...
     *
     * @param test        an instance of {@link com.demo2do.core.utils.ClasspathScanner.Test} that will be used to filter
     *                    classes
     ...
     *
     * @param test    a Test used to filter the classes that are discovered
     * @param parent  the parent package under which classes must be in order to be
     *                considered
